...
export default function EditorialPhases() {
  return (
    <section className='py-[200px] w-full'>
      <div className='w-[90%] mx-auto mb-6 grid grid-cols-12 gap-x-4 md:gap-x-6'>
        <div className='hidden md:block md:col-span-1'></div>
        <div className='col-span-12 md:col-span-5'>
          <h2 className='font-sans text-2xl font-medium leading-snug md:text-[80px] md:leading-[120%]'>
            How We Build Faster, Smarter
          </h2>
        </div>
        <div className='col-span-12 md:col-span-5'>
          <p className='font-sans text-[28px] text-[#001524] font-light leading-snug md:leading-[140%]'>
      ...
      <div className='w-[90%] mx-auto grid grid-cols-12 gap-x-4 md:gap-x-6 py-[100px] '>
        ...
        <div className='col-span-8'>
          <p className='font-sans text-[40px] text-[#001524] font-medium leading-snug md:leading-[120%] mb-[16px]'>
