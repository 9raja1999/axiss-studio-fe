...
export default function EditorialBanner({
  ...
  return (
    <section
      className='relative h-screen w-full bg-no-repeat bg-contain'
      style={{
        backgroundImage: "url('/images/vectors/banner.png')",
    ...
    >
      ...
      {/* Slider */}
      <div className='absolute bottom-4 md:bottom-[10%] right-0 md:w-1/4 w-full md:transform-none px-4'>
